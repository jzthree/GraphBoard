...
(function (tfgraph) {
    ...
    (function (template) {
        ...
        function isSimilarSubgraph(g1, g2) {
            if (!tfgraph.hasSimilarDegreeSequence(g1, g2)) {
                return false;
            }
        ...
        function isSimilarNode(n1, n2) {
            if (n1.type === tfgraph.NodeType.META) {
                // compare metanode
                var metanode1 = n1;
                var metanode2 = n2;
            ...
            else if (n1.type === tfgraph.NodeType.OP && n2.type === tfgraph.NodeType.OP) {
                // compare leaf node
                return n1.op === n2.op;
            }
            else if (n1.type === tfgraph.NodeType.SERIES && n2.type === tfgraph.NodeType.SERIES) {
    ...
    })(template = tfgraph.template || (tfgraph.template = {}));
})(tfgraph || (tfgraph = {}));
