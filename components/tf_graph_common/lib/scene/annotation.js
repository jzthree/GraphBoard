        ...
        (function (annotation_1) {
            ...
            function buildGroup(container, annotationData, d, sceneElement) {
                ...
                annotationGroups.enter()
                    ...
                    if (a.annotationType !== tfgraph.render.AnnotationType.ELLIPSIS) {
            ...
            function annotationToClassName(annotationType) {
                return (tfgraph.render.AnnotationType[annotationType] || '').toLowerCase() || null;
            }
            function buildShape(aGroup, a) {
                if (a.annotationType === tfgraph.render.AnnotationType.SUMMARY) {
            ...
            function addAnnotationLabel(aGroup, label, a, additionalClassNames) {
                ...
                var txtElement = aGroup.append('text')
                    ...
                    .text(label);
                return tfgraph.scene.node.enforceLabelWidth(txtElement, -1);
            }
            function addInteraction(selection, d, annotation, sceneElement) {
                ...
                if (annotation.annotationType !== tfgraph.render.AnnotationType.SUMMARY &&
                    annotation.annotationType !== tfgraph.render.AnnotationType.CONSTANT) {
            ...
            function update(aGroup, d, a, sceneElement) {
                var cx = tfgraph.layout.computeCXPositionOfNodeShape(d);
                ...
                if (a.renderNodeInfo &&
                    a.annotationType !== tfgraph.render.AnnotationType.ELLIPSIS) {
