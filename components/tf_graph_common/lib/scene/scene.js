...
(function (tfgraph) {
    ...
    (function (scene) {
        ...
        function fit(svg, zoomG, d3zoom, callback) {
            ...
            var params = tfgraph.layout.PARAMS.graph;
         ...
         *   <g class='core'>
         *     <g class='edges'>
         *       ... stuff from tfgraph.scene.edges.build ...
         *     </g>
         *     <g class='nodes'>
         *       ... stuff from tfgraph.scene.nodes.build ...
         *     </g>
         *   </g>
         *   <g class='in-extract'>
         *     <g class='nodes'>
        ...
        function buildGroup(container, renderNode, sceneElement, sceneClass) {
            ...
            if (renderNode.node.type === tfgraph.NodeType.SERIES) {
        ...
        function position(sceneGroup, renderNode) {
            ...
            // bounding boxes.
            var yTranslate = renderNode.node.type === tfgraph.NodeType.SERIES ?
                0 : tfgraph.layout.PARAMS.subscene.meta.labelHeight;
            // core
            ...
            if (hasInExtract) {
                var offset = tfgraph.layout.PARAMS.subscene.meta.extractXOffset;
        ...
        function positionButton(button, renderNode) {
            var cx = tfgraph.layout.computeCXPositionOfNodeShape(renderNode);
            ...
            if (renderNode.node.type === tfgraph.NodeType.SERIES && !renderNode.expanded) {
                x += 10;
                y -= 2;
            }
            var translateStr = 'translate(' + x + ',' + y + ')';
            button.selectAll('path').transition().attr('transform', translateStr);
            button.select('circle').transition().attr({ cx: x, cy: y, r: tfgraph.layout.PARAMS.nodeSize.meta.expandButtonRadius });
        }
        ...
        ;
    })(scene = tfgraph.scene || (tfgraph.scene = {}));
